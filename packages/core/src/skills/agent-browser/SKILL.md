---
name: agent-browser
description: Browser automation CLI for AI agents. Use when the user needs to browse websites, perform browser actions, or search for information across major search engines. It can open pages, navigate sites, click interactive elements, extract content, search for news, look up the latest information, and handle other web-related tasks requiring live browser interaction.
